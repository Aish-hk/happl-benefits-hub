...
const faqs = [
  {
    q: "Who is covered under this plan?",
    a: "You and your immediate dependents (spouse/partner and children up to 26).",
  },
  {
    q: "When does the coverage start?",
    a: "Coverage begins on your first day of employment. No waiting period for standard benefits.",
  },
  {
    q: "How do I make a claim?",
    a: "Submit claims through the Happl app or email claims@happl.com with your receipts.",
  },
];
...
export default function BenefitInsurance() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={fadeUp}
        className="rounded-2xl bg-gradient-to-r from-primary to-happl-teal-light p-8 mb-8"
      >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="happl-badge bg-accent/20 text-accent text-xs">
                  Enrolled
                </span>
              </div>
          ...
          <motion.div variants={fadeUp} className="mt-8">
            ...
            <div className="space-y-2">
              {faqs.map((faq, i) => (
                <motion.div
                  key={i}
                  className="happl-card-static cursor-pointer"
          ...
          <div className="happl-card-static">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-accent text-accent-foreground py-2.5 rounded-lg text-sm font-semibold hover:brightness-95 transition-all"
              >
                Manage Plan
              </button>
